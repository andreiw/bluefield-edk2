  ...
  )
{
  ...
  mResAperture[0][0].MemBase        = (UINT64)PcdGet64 (PcdPciMmio32Base);
  mResAperture[0][0].MemLimit       = (UINT64)PcdGet64 (PcdPciMmio32Base) +
                                      PcdGet64 (PcdPciMmio32Size) - 1;
  mResAperture[0][0].MemTranslation = PcdGet64 (PcdPciMmio32Translation);
  ...
  Status = gDS->AddMemorySpace (
                  ...
                  (UINT64)PcdGet64 (PcdPciMmio32Base) + PcdGet64 (PcdPciMmio32Translation),
          ...
          if (RootBridgeInstance->ResAllocNode[Index].Status != ResNone) {
            ...
            switch (Index) {
              ...
              case TypeMem32:
                ...
                BaseAddress = mResAperture[0][0].MemLimit + mResAperture[0][0].MemTranslation;
                ...
                if (!EFI_ERROR (Status)) {
                  ...
                  RootBridgeInstance->ResAllocNode[Index].Base   = (UINTN)BaseAddress - mResAperture[0][0].MemTranslation;
                  RootBridgeInstance->ResAllocNode[Index].Status = ResAllocated;
